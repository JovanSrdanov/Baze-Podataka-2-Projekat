...
CREATE TABLE narudzbina (
    ...
    upravlja_idres        INTEGER NOT NULL,
    upravlja_idosb        INTEGER NOT NULL
);
...
CREATE TABLE stundetskakartica (
...
ALTER TABLE stundetskakartica ADD CONSTRAINT stundetskakartica_pk PRIMARY KEY ( idstudk );
...
ALTER TABLE narudzbina
    ADD CONSTRAINT narudzbina_upravlja_fk FOREIGN KEY ( upravlja_idres,
                                                        upravlja_idosb )
